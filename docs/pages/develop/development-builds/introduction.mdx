...
<BoxLink
  ...
  Icon={BookOpen02Icon}
/>App Name: Islamic Video Hub
Description: د علماوو اسلامي بیانونه او ویډیوګانې په یو ځای کې
Language: Pashto
Theme Color: Green (#0F9D58)
Mode: Light + Dark
🎨 2. Logo (ستا جوړ شوی)
👉 دا Logo وکاروه (Upload یې کړه په App کې):
🕌 مسجد + قرآن ډیزاین
شین Background
Text: Islamic Video Hub
(همدا تصویر چې ما درکړی — هماغه Upload کړه)
...
Plain text
Copy code
Grid Style Categories:

📖 تفسیر القرآن
🕌 جمعه بیان
🎤 اسلامي وعظ
📚 حدیث درس
❤️ 6. User Interaction Settings
Plain text
Copy code
Like: ON 👍
Comment: ON 💬
...
Plain text
Copy code
دا اپ د اسلامي ویډیوګانو لپاره جوړ شوی دی

تاسو کولی شئ:
✔ بیانونه وګورئ
✔ Like او Comment وکړئ

Developer: Sahil Hamdard
📝 11. Play Store Package (کاپي کړه)
Short Description
Plain text
Copy code
د علماوو اسلامي ویډیوګانې، بیانونه او نصیحتونه په یو ځای کې
Full Description
Plain text
Copy code
Islamic Video Hub یو اسلامي اپ دی چې تاسو ته د علماوو ښکلي بیانونه، وعظونه او د قرآن تفسیر وړاندې کوي.

فیچرز:
✔ ویډیوګانې وګورئ
✔ Like، Comment او Share وکړئ
✔ مختلف Categories وپلټئ
✔ Popular ویډیوګانې وګورئ

دا اپ د اسلام د خپرولو لپاره جوړ شوی 🌙

Developer: Sahil Hamdard
⚙️ 12. Final Settings (ډېر مهم)
Plain text
Copy code
